...
class Item(Resource):
    ...
    def post(cls, name: str):
        ...
        # if error here, it will crash resource and error will bubble up,
        # layer by layer, until it reaches the top most layer of our app 
        # which is app.py, @app.errorhandler(ValidationError)
